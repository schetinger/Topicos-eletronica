...
def grafico_individual(carta):
    ...
    plt.title("Análise de Controle - Lista 1", fontsize=14, fontweight='bold')
    plt.xlabel("Índice do Ponto (Ordem de Entrada)")
    plt.ylabel("Valores")
